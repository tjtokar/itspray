      ...
      <div class="p-5 shop-holder d-flex" style="background-image:url('<?php the_sub_field('background'); ?>');">
        <div class="headline align-self-center col-6 pl-5 <?php the_sub_field('text_placement'); ?>">
          ...
          <div class="buttons buttons-<?php the_sub_field('color'); ?> mt-5">
              <a href="<?php the_sub_field('buy_button_link'); ?>" class="btn btn-primary btn-<?php the_sub_field('color'); ?> px-5 py-2"><?php the_sub_field('buy_button_text'); ?></a>
              <a href="<?php the_sub_field('why_button_link'); ?>" class="btn btn-secondary btn-<?php the_sub_field('color'); ?>-reverse px-5 py-2"><?php the_sub_field('why_button_text'); ?></a>
          </div>
        </div>
        <div class="col-6">
