<section class="section shop" data-section-name="why">
  <div class="s-slider">
    <?php if( have_rows('slides') ): while ( have_rows('slides') ) : the_row(); ?>
      ...
      <div class="p-sm-5 shop-holder d-xs-block d-sm-flex <?php the_sub_field('color'); ?>" style="background-image:url('<?php the_sub_field('background'); ?>');">
        <div class="headline align-self-center col-xs-12 col-sm-6 pl-sm-5 <?php the_sub_field('text_placement'); ?>">
        ...
        <div class="col-xs-12 col-sm-6 bubbles-pop">
          ...
          <?php if( have_rows('bubbles') ): while ( have_rows('bubbles') ) : the_row(); ?>
            ...
            <div class="bubble left-<?php the_sub_field('left'); ?> <?php the_sub_field('size'); ?> <?php the_sub_field('bubble_color'); ?>" data-animation-in="zoomIn" data-delay-in="<?php the_sub_field('animation_delay'); ?>" style="top:<?php the_sub_field('top'); ?>%;left:<?php the_sub_field('left'); ?>%;">
